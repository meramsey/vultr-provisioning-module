...
if (!class_exists('VultrHelper')) {
    class VultrHelper
    {
        public static function parseRegions($data): string
        {
            $regions = '';
        ...
        public static function parsePlans($data): array
        {
            $plans = array();
            foreach ($data['plans'] as $key => $value) {
                if (empty($value['available_locations'])) {
                    unset($data[$key]);
                    continue;
                } else {
                    $plans[$value['id']] = $value['id'] . '|' . $value['vcpu_count'] . ' (' . $value['type'] . ') - ' . $value['monthly_cost'] . '$';
                }
            }
            return $plans;
        }

        public static function parseOS($data): string
        {
            $os = '';
            foreach ($data as $key => $value) {
                $os .= ',' . $value['name'];
        ...
        public static function parseAPPS($data): string
        {
            $apps = '';
            foreach ($data as $key => $value) {
        ...
        public static function getOsFamilyList($data): array
        {
            $oses = array();
            foreach ($data as $key => $value) {
        ...
        public static function getPayAppList($data): array
        {
            $apps = array();
            foreach ($data as $key => $value) {
        ...
        public static function configurableOptions($productID): array
        {
        ...
        public static function customFields($productID): array
        {
        ...
        private static function prepareConfigurableOptions($vultrAPI, $productID): array
        {
        ...
        public static function startVMAction($params): array
        {
        ...
        public static function rebootVMAction($params): array
        {
            $vmParams = self::getVMParams($params);
            if ($vmParams["service"]->domainstatus != 'Active') {
                return array('status' => false, 'message' => LangHelper::T('core.ajax.service_not_active'));
        ...
        public static function stopVMAction($params): array
        {
            $vmParams = self::getVMParams($params);
            if ($vmParams["service"]->domainstatus != 'Active') {
                return array('status' => false, 'message' => LangHelper::T('core.ajax.service_not_active'));
        ...
        public static function reinstallVMAction($params): array
        {
            $vmParams = self::getVMParams($params);
            if ($vmParams["service"]->domainstatus != 'Active') {
                return array('status' => false, 'message' => LangHelper::T('core.ajax.service_not_active'));
        ...
        public static function checkStatusVMAction($params): array
        {
            $vmParams = self::getVMParams($params);
            if ($vmParams) {
        ...
        public static function getUserServiceSnapshots($snapshots, $clientID, $serviceID = false): array
        {
        ...
        public static function getGlobalSnapshots($snapshotList): array
        {
        ...
        public static function removeUncompleteSnapshots($snapshotList = []): array
        {
            $allSnapshots = [];
            foreach ($snapshotList as $key => $value) {
        ...
        public static function getAllSnapshots($snapshotList, $userId): array
        {
        ...
        public static function getUserScripts($clientID, $scripts): array
        {
        ...
        public static function getUserBackups($backups, $servers, $clientID): array
        {
        ...
        public static function recalcSize($size): string
        {
        ...
        public static function getAllOSAndAppCustomFields(): array
        {
        ...
        public static function getAllowProductUpgradeOptions(): array
        {
            $fields = Capsule::table('tblproductconfigoptions')
                ->join('tblproductconfiglinks', 'tblproductconfiglinks.gid', '=', 'tblproductconfigoptions.gid')
                ->join('tblproducts', 'tblproductconfiglinks.pid', '=', 'tblproducts.id')
        ...
        public static function getAllowOSChange($params): array
        {
        ...
        public static function getAllowAPPsChange($params): array
        {
            $serviceInfo = Capsule::table('tblhosting')->where('id', $params['id'])->first();
            $pInfo = Capsule::table('tblproducts')->where('id', $serviceInfo->packageid)->first();
            if ($pInfo->servertype == 'vultr') {
        ...
        public static function compareOS($sid, $los, $ros): bool
        {
            $fields = Capsule::table('tblproductconfigoptions')
                ->join('tblproductconfiglinks', 'tblproductconfiglinks.gid', '=', 'tblproductconfigoptions.gid')
                ->join('tblproducts', 'tblproductconfiglinks.pid', '=', 'tblproducts.id')
        ...
        public static function compareAPP($sid, $los, $ros): bool
        {
            $fields = Capsule::table('tblproductconfigoptions')
                ->join('tblproductconfiglinks', 'tblproductconfiglinks.gid', '=', 'tblproductconfigoptions.gid')
                ->join('tblproducts', 'tblproductconfiglinks.pid', '=', 'tblproducts.id')
        ...
        public static function checkIsVultrUpgrade($hostingId): bool
        {
        ...
        public static function checkIsVMCreated($hostingId): bool
        {
        ...
        public static function buildServiceParams($hostingId): array
        {
        ...
        public static function checkRevDNSUpdated($serviceID): bool
        {
