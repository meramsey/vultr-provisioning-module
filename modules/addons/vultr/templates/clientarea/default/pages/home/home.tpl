<!doctype html>
<html><head></head><body><div class="box light">
	<div class="row">
		<div class="col-lg-12" id="mg-categories-content">
			...
			<div class="well-sm card" style="margin-top:10px;">
					...
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
								...
								<div class="modal-alerts">
									<div style="display:none;" data-prototype="error">
										<div class="note note-danger">
											<button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">×</span><span class="sr-only"></span>
											</button>
											<strong></strong>
							...
							<div class="modal-footer">
								...
								<button type="button" class="btn btn-secondary" data-dismiss="modal">{$MGLANG->T('modal','close')}</button>
							</div>
						</div>
					</div>
				</div>
