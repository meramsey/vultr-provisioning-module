<!doctype html>
<html><head></head><body><div class="mg-wrapper body" data-target=".body" data-spy="scroll" data-twttr-rendered="true">
	...
	<link rel="stylesheet" type="text/css" href="{$assetsURL}/css/simple-line-icons.css">
	<link rel="stylesheet" type="text/css" href="{$assetsURL}/css/bootstrap.css">
	<link rel="stylesheet" type="text/css" href="{$assetsURL}/css/uniform.default.css">
	...
	<link rel="stylesheet" type="text/css" href="{$assetsURL}/css/mg-style.css">
					...
					<div class="nav-menu">
						<ul class="nav navbar-nav">
							{foreach from=$menu key=catName item=category}
								...
								{else}
									<li>
										<a href="{if $category.externalUrl}{$category.externalUrl}{else}{$category.url}{/if}" {if="" $catname="=$currentPageName}class=&quot;active&quot;{/if}" $category.externalurl}target="_blank" {="" if}="">
										{if $category.icon}<i class="{$category.icon}"></i>{/if}
										{if $category.label}
