...
class Orm extends Base
{
    ...
    protected function getRawData($id, $haveToExits = true): array
    {
    ...
    public static function fieldDeclaration(): array
    {
     ...
     * @throws \MGModule\vultr\mgLibs\exceptions\System
     */
    public static function getProperyColumn($property)
    {
        $tableStructure = self::getTableStructure();
     ...
     */
    public static function getTableStructure($force = false)
    {
