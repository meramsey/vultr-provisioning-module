...
abstract class Repository
{
    ...
    public function getProperyColumn($property)
    {
     ...
     * @throws \MGModule\vultr\mgLibs\exceptions\System
     */
    public function delete(): main\mgLibs\MySQL\result
    {
     ...
     */
    public function idIn(array $ids): Repository
    {
        foreach ($ids as &$id) {
            $id = (int)$id;
        }
     ...
     * @return Repository
     */
    public function resetFilters(): Repository
    {
        $this->_filters = array();
        $this->_order = array();
        $this->_limit = null;
